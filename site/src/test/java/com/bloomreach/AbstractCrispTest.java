...
import org.onehippo.cms7.crisp.core.broker.CacheableResourceServiceBroker;
...
public abstract class AbstractCrispTest {
    ...
    @Autowired
    public ResourceResolverProvider resourceResolverProvider;

    @Autowired
    public CacheableResourceServiceBroker cacheableResourceServiceBroker;
